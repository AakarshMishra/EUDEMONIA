...
public class Catastrophizing extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_catastrophizing);
            ...
            public void onClick(View v) {
                ...
                reference.updateChildren(user).addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        ...
                        {
                            Toast.makeText(Catastrophizing.this,"Message Posted Successfully!",Toast.LENGTH_LONG).show();
                            Intent i=new Intent(getApplicationContext(),Councellors.class);
                            i.putExtra("Age","18");
                            i.putExtra("Problem","Catastrophizing");
                            startActivity(i);
                        }
                        else {
                            Toast.makeText(Catastrophizing.this,"Message Posting Unsucessful!",Toast.LENGTH_LONG).show();
                        }
                    }
                });
