...
public class Blamer extends AppCompatActivity {
    EditText message;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_blamer);
            ...
            public void onClick(View v) {
                ...
                reference.updateChildren(user).addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        ...
                        {
                            Toast.makeText(Blamer.this,"Message Posted Successfully!",Toast.LENGTH_LONG).show();
                            Intent i=new Intent(getApplicationContext(),Councellors.class);
                            i.putExtra("Age","18");
                            i.putExtra("Problem","Blamer");
                            startActivity(i);
                        }
                        else {
                            Toast.makeText(Blamer.this,"Message Posting Unsucessful!",Toast.LENGTH_LONG).show();
                        }
                    }
                });
