            ...
            public void onClick(View v) {
                ...
                reference.updateChildren(user).addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        ...
                        {
                            Toast.makeText(Emotional.this,"Message Posted Successfully!",Toast.LENGTH_LONG).show();
                            Intent i=new Intent(getApplicationContext(),Councellors.class);
                            i.putExtra("Age","18");
                            i.putExtra("Problem","Emotional");
                            startActivity(i);
                        }
                        else {
                            Toast.makeText(Emotional.this,"Message Posting Unsucessful!",Toast.LENGTH_LONG).show();
                        }
                    }
                });
